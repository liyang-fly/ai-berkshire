...
| 本地笔记维度 | 填入研究模块 | 大师框架 |
|------------|------------|---------|
| 投资逻辑链 | 第一步：投资逻辑链构建与验证 | 通用 |
| 产业链 | 第二步：产业链全景图绘制 | 通用 |
| 行业趋势 | 第一步 + 第六步：文明趋势判断 | 李录 |
| 竞争格局 | 第三步：全球上市公司扫描 | 通用 |
| 生意本质 | 第四步：头部公司分析 | 段永平 |
| 护城河 | 第四步：头部公司分析 | 巴菲特 |
| 风险 | 第五步：行业级风险评估 | 芒格 |
| 估值 | 第四步：头部公司分析 | 巴菲特+段永平 |

5. **在报告中优先引用本地信息**，标注"📌本地信息源"标签，注明记录日期和可信度
6. 本地信息已覆盖的维度，减少网络搜索深度

**如果本地无信息**：记录"本地信息源：无"，继续正常研究流程。建议用户使用 `/local-info` 录入行业观察。
